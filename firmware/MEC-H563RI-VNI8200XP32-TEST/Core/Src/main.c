...
static const char *vni8200xp32_status_str(vni8200xp32_status_t status)
{
    switch (status)
    {
        case VNI8200XP32_OK:          return "OK";
        case VNI8200XP32_E_NULL:      return "E_NULL";
        case VNI8200XP32_E_PARAM:     return "E_PARAM";
        case VNI8200XP32_E_HW:        return "E_HW";
        case VNI8200XP32_E_TIMEOUT:   return "E_TIMEOUT";
        case VNI8200XP32_E_RX_PARITY: return "E_RX_PARITY";
        case VNI8200XP32_E_SPI:       return "E_SPI";
        case VNI8200XP32_E_FB:        return "E_FB";
        case VNI8200XP32_E_TWARN:     return "E_TWARN";
        case VNI8200XP32_E_PG:        return "E_PG";
        case VNI8200XP32_E_OVT:       return "E_OVT";
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : GR_LED_Pin YE_LED_Pin RE_LED_Pin */
  GPIO_InitStruct.Pin = GR_LED_Pin|YE_LED_Pin|RE_LED_Pin;
