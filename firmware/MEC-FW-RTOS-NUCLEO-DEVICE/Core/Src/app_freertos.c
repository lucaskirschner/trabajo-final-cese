...
void MX_FREERTOS_Init(void) {
  ...
  radioInputQueueHandle = osMessageQueueNew (16, sizeof(uint32_t), &radioInputQueue_attributes);
  /* creation of radioOutputQueue */
  radioOutputQueueHandle = osMessageQueueNew (16, sizeof(uint32_t), &radioOutputQueue_attributes);
