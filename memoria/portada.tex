...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Sistema modular para monitoreo y control industrial con comunicación inalámbrica y capacidades de automatización embebida} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Ing. Lucas Sebastián Kirschner} \\[1cm]
        ...
        \textbf{Director:} Mg. Ing. Guillermo Alfredo Fernández (UNaM)} \\[1cm]
        ...
        Ciudad de Salto Encantado, octubre de 2026} % Ejemplo: Ciudad de Córdoba, junio de 2025
    \end{flushright}
\end{titlepage}
