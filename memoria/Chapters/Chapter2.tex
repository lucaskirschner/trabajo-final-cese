...
Complementariamente a la plataforma de procesamiento basada en el STM32H\-563RI, el sistema incorpora distintos circuitos integrados y módulos externos orientados a la adquisición de señales industriales, manejo de salidas, comunicación cableada e inalámbrica y validación del firmware durante las etapas de desarrollo. A continuación, se describen los componentes más relevantes utilizados en el trabajo.
